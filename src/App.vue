        ...
        <div class="search-items">
          ...
          <div class="filter-container">
            <div class="f-item">
              ...
              <select
                name="scf_select"
                v-model="scf_select_value"
                @change="set_url_by_type(scf_select_value)"
              >
            ...
            <div class="f-item">
              <span>last or revelant&nbsp;</span>
              <select
                name="lr_select"
                v-model="lr_select_value"
                @change="set_url_by_lat(lr_select_value)"
              >
            ...
            <div class="f-item">
              ...
              <select
                name="hits_select"
                v-model="hits_select_value"
                @change="set_news_hits(hits_select_value)"
              >
